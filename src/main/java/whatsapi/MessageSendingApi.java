...
public class MessageSendingApi {
    ...
    /**
     * Build call for uploadMediaFromUrl
     * @param instanceKey Instance key (required)
     * @param type Media type (required)
     ...
     */
    public okhttp3.Call uploadMediaFromUrlCall(String instanceKey, String type, UrlMediaUploadPayload data, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/instances/{instance_key}/send/upload-url"
            .replace("{" + "instance_key" + "}", localVarApiClient.escapeString(instanceKey.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call uploadMediaFromUrlValidateBeforeCall(String instanceKey, String type, UrlMediaUploadPayload data, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'instanceKey' is set
        if (instanceKey == null) {
            throw new ApiException("Missing the required parameter 'instanceKey' when calling uploadMediaFromUrl(Async)");
        }

        // verify the required parameter 'type' is set
        if (type == null) {
            throw new ApiException("Missing the required parameter 'type' when calling uploadMediaFromUrl(Async)");
        }

        // verify the required parameter 'data' is set
        if (data == null) {
            throw new ApiException("Missing the required parameter 'data' when calling uploadMediaFromUrl(Async)");
        }

        return uploadMediaFromUrlCall(instanceKey, type, data, _callback);
     ...
     */
    public ModelAPIResponse uploadMediaFromUrl(String instanceKey, String type, UrlMediaUploadPayload data) throws ApiException {
        ApiResponse<ModelAPIResponse> localVarResp = uploadMediaFromUrlWithHttpInfo(instanceKey, type, data);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ModelAPIResponse> uploadMediaFromUrlWithHttpInfo(String instanceKey, String type, UrlMediaUploadPayload data) throws ApiException {
        okhttp3.Call localVarCall = uploadMediaFromUrlValidateBeforeCall(instanceKey, type, data, null);
        Type localVarReturnType = new TypeToken<ModelAPIResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Upload media from url. (asynchronously)
     * Uploads media from a url to WhatsApp servers and returns the media keys. Store the returned media keys, as you will need them to send media messages
     * @param instanceKey Instance key (required)
     * @param type Media type (required)
     * @param data Media data (required)
     ...
     */
    public okhttp3.Call uploadMediaFromUrlAsync(String instanceKey, String type, UrlMediaUploadPayload data, final ApiCallback<ModelAPIResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = uploadMediaFromUrlValidateBeforeCall(instanceKey, type, data, _callback);
        Type localVarReturnType = new TypeToken<ModelAPIResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
