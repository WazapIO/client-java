...
public class ListItem {
  ...
  **/
  ...
  public ListItem rowId(String rowId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, listItem.description) &&
        Objects.equals(this.rowId, listItem.rowId) &&
        Objects.equals(this.title, listItem.title);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListItem
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ListItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListItem` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListItem.openapiRequiredFields) {
